      ...
      <div className={styles.formShell}>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={styles.inputForm}>
            ...
            />
            <svg className={styles.icon} viewBox="0 0 576 512" height="16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <div className={styles.flexRow}>
            ...
            <button type="button" className={styles.btn}>
              <svg version="1.1" height="20" width="20" viewBox="0 0 22.773 22.773" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <g>
                  <g>

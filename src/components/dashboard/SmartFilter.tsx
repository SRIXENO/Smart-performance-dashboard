...
export default function SmartFilter({
  ...
  return (
    <div className="interactive-card bg-white rounded-xl shadow-lg p-4 mb-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          <button
            onClick={() => setIsExpanded(!isExpanded)}
            className="interactive-btn flex items-center space-x-2 text-gray-700 hover:text-gray-900 font-medium"
          >
        ...
        {activeFilterCount > 0 && (
          <button
            ...
            className="interactive-btn text-sm text-red-600 hover:text-red-800 font-medium"
          >
            Clear All
          </button>
        )}
          ...
          {showDepartment && (
            <div>
              ...
              <select
                ...
                className="interactive-btn w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
